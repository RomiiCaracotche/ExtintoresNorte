...
const containerNosotros = [
     ...
     {id:4, titulo:"Nuestros Valores", url:"/img/servicios/camioneta-frente.png", detalle:["Confianza Familiar: Servicio basado en el compromiso y la honestidad.", "Excelencia Tecnica: Cumplimiento riguroso de la normativa legal y estándares IRAM.", "Integridad: Asesoramiento transparente y soluciones necesarias. Compromiso con la Comunidad: Trabajamos para hacer de La Plata un lugar más seguro."]}
];
                              ...
                              <Col xs={11} sm={10} md={9} lg={6} xl={5} className='row-center-center'>
                                   <div className='container-nosotros-texto'>
                                        ...
                                        {Array.isArray(item.detalle)  ?
                                                                      (item.detalle.map((det) => (<p className='text'>{det}</p>))) 
                                                                      : 
