    ...
    return (
        ...
        <div className="container-home">
            ...
            <section className="section-home">  
                <Container className="column-center-center p-0">
                    <h3 className="titulo titulo-home">SOLUCIONES INTEGRALES</h3>
            ...
            {/* ----------- Seccion flota ----------- */}
            <section className="section-flota"> 
                <Container className="column-center-center">
                    <h3 className="titulo titulo-flota">NUESTRA FLOTA</h3>
                    <Row className="row-flota">
                        <Col xs={12} sm={12} md={12} lg={6} xl={6} className="col-flota">
                            <img src="/img/home/camioneta-roja2.png"/>
                        </Col>
                        <Col xs={12} sm={12} md={12} lg={6} xl={6} className="col-flota">
                            <img src="/img/servicios/camioneta-frente.png"/>
                        </Col>
                    </Row>
                </Container>
            </section>      
            ...
            <section className="section-ubicacion">
                <Container>
                        <h3 className="titulo titulo-ubicacion">PODES ENCONTRARNOS EN</h3>
                        <Row className="row-ubicacion">   
                            <Col xs={12} md={10} lg={5} xl={6} xxl={5} className="col-ubicacion">   
                                <div>
                                    <ul className="ul-ubicacion">
                                        <li>LA PLATA,</li>
                                        <li><FaMapLocationDot className="color-light"/> Calle 519 N° 1820 esq. 13</li>
                                    </ul>
                                    <div className="col-ubicacion_img"> 
            ...
            <section className="section-video">
                <Container className="column-center-center">
                    <h3 className="titulo titulo-video">¿ SABIAS ESTO ?</h3>
                    <Row className="row-video">
                        <Col xs={12} md={12} lg={12} xl={6} xxl={6} className="p-0">
                        ...
                        <Col xs={12} md={12} lg={11} xl={6} xxl={6} className="container-video-video">
